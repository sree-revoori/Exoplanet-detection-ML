...
train_data = pd.read_csv('\Users\srrev\Downloads\1074_1995_bundle_archive\exoTrain.csv').fillna(0)
...
#Normally distributed histogram of non-exoplanets
...
#Normally distributed histogram of exoplanets
labels_1=[16,21,25]
for i in labels_1:
    plt.hist(train_data.iloc[i,:], bins=200)
    plt.title("Gaussian Histogram")
...
"""
This plot tells us that by selecting 35 components we can preserve or 99% 
of the total variance of the data. This significantly reduces the dimensionality 
of the data without compromising the variance of the entire data set.
"""
...
#Resampling sine the data is highly unbalanced.
